...
# Map abbreviations to full Portuguese names
book_names = {
    "gn": "Gênesis", "ex": "Êxodo", "lv": "Levítico", "nm": "Números", "dt": "Deuteronômio",
    "js": "Josué", "jz": "Juízes", "rt": "Rute", "1sm": "1 Samuel", "2sm": "2 Samuel",
    "1rs": "1 Reis", "2rs": "2 Reis", "1cr": "1 Crônicas", "2cr": "2 Crônicas",
    "ed": "Esdras", "ne": "Neemias", "et": "Ester", "job": "Jó", "sl": "Salmos",
    "pv": "Provérbios", "ec": "Eclesiastes", "ct": "Cântares", "is": "Isaías",
...
try:
    with open('assets/bible_almeida.json', 'r', encoding='utf-8-sig') as f:
        data = json.load(f)
    ...
    for book in data:
        ...
        name = book_names.get(abbrev, abbrev.capitalize())
        new_data["books"].append({
            "name": name,
            "chapters": book["chapters"]
        })

    with open('assets/bible_data.json', 'w', encoding='utf-8') as f:
        json.dump(new_data, f, ensure_ascii=False, indent=2)

    print("Successfully converted bible_almeida.json to bible_data.json")
